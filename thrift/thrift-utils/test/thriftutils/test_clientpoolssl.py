...
class ThriftClientPoolTest(EzThriftServerTestHarness):
    ...
    def test_get_client(self):
        client = self.clientPool.get_client('ezpz_ssl', EzPz.Client)
        try:
    ...
    def test_multi_get_client(self):
        client1 = self.clientPool.get_client('ezpz_ssl', EzPz.Client)
        client2 = self.clientPool.get_client('ezpz_ssl', EzPz.Client)
        try:
